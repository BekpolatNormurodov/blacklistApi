...
from .views import UsersViewSet, PhonesViewSet, CardsViewSet, TelegramUserViewSet, FriendsView, FriendsCreate, FriendsUpdate, SearchApiView, PhoneSearchDetailView
...
urlpatterns += [
    ...
    path('phone-search/', PhoneSearchDetailView.as_view(), name='phone-search-detail'),
]